...
void AMGLandMine::EndPlay(const EEndPlayReason::Type EndPlayReason)
{
	Super::EndPlay(EndPlayReason);

	UKismetSystemLibrary::PrintString(this, FString::Printf(TEXT("AMGLandMine::EndPlay()")), true, true, FLinearColor::Green, 5.f);
...
void AMGLandMine::OnLandMineBeginOverlap(AActor* OverlappedActor, AActor* OtherActor)
{
	if (HasAuthority() == true)
	{
		UKismetSystemLibrary::PrintString(this, FString::Printf(TEXT("Run on server.")), true, true, FLinearColor::Green, 5.f);
...
void AMGLandMine::GetLifetimeReplicatedProps(TArray<class FLifetimeProperty>& OutLifetimeProps) const
{
...
void AMGLandMine::OnRep_IsExploded()
{
...
void AMGLandMine::MulticastRPCSpawnEffect_Implementation()
{
}
